...
import com.amrsamy.dispatchgrid.adapters.web.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/architecture").permitAll()
                        .requestMatchers("/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html").permitAll()
                        .requestMatchers("/actuator/health", "/actuator/info").permitAll()
                        .requestMatchers(HttpMethod.OPTIONS, "/**").permitAll()
                        .requestMatchers("/api/send/**").hasAnyRole("API", "ADMIN", "OPERATOR")
                        .requestMatchers("/api/demo/**").hasAnyRole("ADMIN", "OPERATOR")
